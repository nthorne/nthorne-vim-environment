...
"    hi Visual ctermbg=7 ctermfg=0 guibg=#ababab guifg=#000000 gui=bold
    hi Visual ctermbg=0 ctermfg=7 guibg=#ababab guifg=#000000 gui=bold
...
"    hi Visual ctermbg=7 ctermfg=0 guibg=#8598ac guifg=#000000 gui=bold
    hi Visual ctermbg=0 ctermfg=7 guibg=#8598ac guifg=#000000 gui=bold
...
hi PreProc ctermbg=bg ctermfg=2 gui=none
hi PreProc guibg=bg guifg=#d7a0d7 gui=none
hi Special guibg=bg guifg=#e0c07e gui=none
hi Statement guibg=bg guifg=#7ec0ee gui=none,underline
